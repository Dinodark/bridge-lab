const steps = [
  {
    ...
    desc: "Launch or back NFT-driven charity campaigns. Every campaign is verified and transparent.",
  },
  {
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    desc: "Donate crypto and receive a unique NFT as proof of your contribution. Forever on-chain.",
  },
  {
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    desc: "Your digital identity grows with every contribution. Share your impact with the world.",
  },
];
