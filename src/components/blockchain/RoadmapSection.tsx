...
export default function RoadmapSection() {
  return (
    <section id="roadmap" className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-12">
          {milestones.map((m, i) => (
            <div key={m.quarter} className="flex items-center">
              <div className="text-center p-6 rounded-xl bg-white/5 border border-white/10 min-w-[180px]">
